...
<link rel="stylesheet" href="/backmanager/css/common.css">
<link rel="stylesheet" href="/backmanager/js/layui/css/layui.css">
<link rel="stylesheet"
...
<!-- ECharts单文件引入 -->
<script src="/backmanager/js/echarts.js"></script>
<script src="/backmanager/js/laydate.js"></script>
<script src="/backmanager/js/layui/layui.js"></script>
<script src="/backmanager/js/dateformat.js"></script>
<style type="text/css">
a {
	margin-left: 8px;
}
...
<body>
	...
	<script type="text/javascript">
		...
		var url = "/backmanager/pdd/manage/order/analysis?mallId=" + owner_id;
