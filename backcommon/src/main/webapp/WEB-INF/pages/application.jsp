						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<select class="form-control" id="type" name="type">
									...
									<option value="3">审核放弃</option>
									<option value="4">审核拒绝</option>
								</select>
							</div>
						</div>
						<div class="form-group">
							<label for="time3" class="col-sm-1 control-label">申请金额</label>
							<div class="col-sm-5">
								<input type="text" class="form-control"
						...
						<tbody id="dataBody">
							<c:forEach var="user" items="${page.list}" varStatus="status">
								<tr>
									...
									<td>${user.applicateAmount}</td>
									<td>${user.amount}</td>
									<td>${user.applicatePeriod}</td>
									<td>${user.auditPeriod}</td>
